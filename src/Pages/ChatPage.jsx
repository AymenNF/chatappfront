...
import LeftChats from './LeftChats'; // Import the LeftChats component
...
const ChatRoom = () => {
    ...
    const [showSidebarPopup, setShowSidebarPopup] = useState(false); // State to manage the visibility of the sidebar popup
...
const connect = (retryCount = 0) => {
    ...
    <div className="containerMsg">
         {/* Left Chats */}
         {/* <LeftChats privateChats={privateChats} tab={tab} setTab={setTab} /> */}
            ...
            {tab==="CHATROOM" && <div className="chat-content">
                <div className="chat-messages">
                    ...
                    {publicChats.map((chat,index)=>(
                        <div className={` message ${chat.senderName === userData.username && " messageItem "}`} key={index} >
                            {chat.senderName !== userData.username &&
                             <div className="senderDiv2" >
